package com.services.cloud.application;
...
import com.services.cloud.provider.MyJacksonJsonProvider;
import com.services.cloud.resource.ServiceRequestHandler;
...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
     ...
     //   resources.add(com.nabisoft.tutorials.jerseyjackson.jaxrs.resource.PersonResource.class);
        resources.add(ServiceRequestHandler.class);
